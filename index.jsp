    ...
    <body>
        <div id="wrapper">
            ...
            <div id = "account_enter">
                ...
                <span id = "signup"><a href="">Sign Up</a></span>
            </div>
            <div id="title-box">
                <h1>What Can I Cook?</h1>
            </div>
            <form id="recipe-search">
                <label for="ingredient-input">Ingredients:</label><br>
                ...
                <div id = "diet-cat">
                    ...
                    <input type="checkbox" id="atkins" value="Atkins">
                    <label for="atkins"> Atkins </label>
                    ...
                    <label for="kosher"> Kosher-friendly </label>
                </div>
                <label for="food-cat">Category:</label><br>
                <div id = "food-cat">
                    <input type="radio" id="baked-goods" name = "food-cat">
                    <label for="baked-goods">Baked Goods</label>
                    <input type="radio" id="bread" name = "food-cat">
                    <label for="bread">Bread</label>
                    <input type="radio" id="soups-stews" name = "food-cat">
                    <label for="soups-stews">Soups and Stews</label>
                    <input type="radio" id="salads" name = "food-cat">
                    <label for="salads">Salads</label>
                    <input type="radio" id="sauce" name = "food-cat">
                    <label for="sauce">Dressings and Sauces</label>
                    <input type="radio" id="snacks" name = "food-cat">
                    <label for="snacks">Snacks</label>
                    <input type="radio" id="main-dishes" name = "food-cat">
